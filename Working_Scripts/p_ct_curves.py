...
# power as listed by NREL in units of kW and should be in units of Watts to hand to PyWake, so multiply by 1000
NREL15power_curve = np.loadtxt("IEA_15MW_240_RWT.csv", delimiter=',', skiprows=1, usecols=[0, 1])*[1, 1000]
